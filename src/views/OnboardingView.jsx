      ...
      <div className="rounded-[36px] p-6 glass-card-ios border border-white/90 shadow-xl shadow-indigo-500/10 text-center flex flex-col items-center relative overflow-hidden">
        ...
        <h2 className="text-xl sm:text-2xl font-extrabold text-slate-900 mb-2 leading-tight">
          <EditableText
            stepId="onboarding"
            fieldKey="title"
            defaultText="การออกแบบการอบรมครูเรื่อง Digital Citizenship"
        ...
        <p className="text-xs text-slate-600 leading-relaxed mb-5 max-w-xs font-medium">
          <EditableText
            stepId="onboarding"
            fieldKey="subtitle"
            defaultText="โครงการ M-Training พัฒนาสมรรถนะดิจิทัลสำหรับครู รองรับ Mosher & Gottfredson Level 2 & 3"
            multiline
          />
        </p>

        {/* Editable CTA Pill Button */}
        <button
        ...
        >
          ...
          <EditableText
            stepId="onboarding"
            fieldKey="ctaText"
            defaultText="Chat & Learn Module 1"
          />
          <ArrowRight className="w-4 h-4" />
        </button>
      </div>

      {/* 3-Week Training Roadmap */}
